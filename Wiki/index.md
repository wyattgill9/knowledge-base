...
| [[compio]] | Cross-platform completion-based async runtime (io_uring + IOCP + polling fallback) | rust, concurrency, crate |
...
| [[glommio]] | Datadog's io_uring runtime with three-ring architecture and share-based scheduling | rust, concurrency, performance, crate |
...
| [[io-uring]] | Linux completion-based async I/O with fundamental cancellation safety challenges in Rust | rust, performance, concurrency, architecture |
...
| [[monoio]] | ByteDance's io_uring runtime achieving ~3x Tokio throughput with thread-per-core architecture | rust, concurrency, performance, crate |
...
| [[thread-per-core]] | Server architecture pattern maximizing cache locality with per-core event loops | rust, performance, concurrency, architecture |
...
| [[tokio]] | Rust's dominant async runtime and networking ecosystem foundation | rust, concurrency, crate, performance |
